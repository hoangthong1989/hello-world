...
var Ma_off = ["174","175","239","258","252","233",""]; // 
	...
	{// check nếu số lượng off chưa làm xong 
		...
		{ 
			...
			{ // Kiểm Tra Title Site Hiện Tại
				...
				{ // 47 57 11 20 27 66 12 67 8 77 79 104 127 157 159 173 177 175 182 193 251 258 277 195
				    try
					{
						switch(Check_Off)
						{
							case "195":case "277":case "258":case "251":case "193":case "182":
	...
	while(true)
	{
		...
		if(capcha == true)
		{
			...
			{// Khao Sat DAILY
				switch(Check_Off)
				{
					case "195":case "277":case "258":case "251":case "193":case "178":case "182":

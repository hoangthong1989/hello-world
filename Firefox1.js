...
var Ma_off = ["245","185","177","239","193","233",""];
// var Ma_off = ["245","84","177","239","193","233",""]; // 185
	...
	{// check nếu số lượng off chưa làm xong 
		...
		{ 
			...
			{ // Kiểm Tra Title Site Hiện Tại 
				...
				{ // 47 57 11 20 27 66 12 67 8 77 79 104 127 157 159 173 177 175 182 193 251
				    try
					{
						switch(Check_Off)
						{
							case "251":case "193":case "182":
				...
				{ // 23 45 50 18 1 83 10 26 176 181 172 171 221 203 233 240
					try
					{
						switch(Check_Off)
						{
	...
	while(true)
	{
		...
		if(capcha == true)
		{
			...
			{// Khao Sat DAILY
				switch(Check_Off)
				{
					case "251":case "193":case "178":case "182":

...
var Ma_off = ["25","258","173","291","281","240"]; // 
	...
	{// check nếu số lượng off chưa làm xong 
		...
		{ 
			...
			{ // Kiểm Tra Title Site Hiện Tại
				...
				{ // 47 57 11 20 27 66 12 67 8 77 79 104 127 157 159 173 177 175 182 193 251 258 277 195 129
				    try
					{
						switch(Check_Off)
						{
							case "129":case "195":case "277":case "258":case "251":case "193":case "182":
				...
				{ // 17 22 71 76 25 86 109 123 84 145 78 180 179 178 39 239 241
					try
					{
						switch(Check_Off)
						{
	...
	while(true)
	{
		...
		if(capcha == true)
		{
			...
			{// Khao Sat DAILY
				switch(Check_Off)
				{
					case "129":case "195":case "277":case "258":case "251":case "193":case "178":case "182":

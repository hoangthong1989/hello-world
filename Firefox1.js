...
var Ma_off = ["174","341","175","316","352","319",""];
// var Ma_off = ["363"];
	...
	{// Con Neu Chua Thi Tiến hành làm offer  
		...
		{ 
			...
			{ // Neu Site Co Title La Khong Rong
				...
				{ // 104 127 157 159 173 177 175 182 193 251 258 277 195 129 297 341 343 361 363
				    try
					{
						switch(Check_Off)
						{
							case "363":case "361":case "343":
...
function TopSweeps(File_Mail_info)
{
	...
	TopSweeps += "WAIT SECONDS=3"+"\n";
	TopSweeps += "TAG POS=1 TYPE=BUTTON FORM=NAME:NoFormName ATTR=ID:i-faf88311-0356-4c19-8a56-9b41a5601726"+"\n";
	TopSweeps += "WAIT SECONDS=0.5"+"\n";
	...
	TopSweeps += "WAIT SECONDS=0.5"+"\n";
	TopSweeps += "TAG POS=1 TYPE=BUTTON FORM=NAME:NoFormName ATTR=ID:i-275a97c6-ff03-4498-9e62-02b15c2c9197"+"\n";
	TopSweeps += "WAIT SECONDS=0.5"+"\n";
	TopSweeps += "TAG POS=1 TYPE=BUTTON FORM=NAME:NoFormName ATTR=ID:i-99909bb9-8233-4114-80cb-c1d826749605"+"\n";
	TopSweeps += "WAIT SECONDS=3"+"\n";
	...
	TopSweeps += "WAIT SECONDS=0.5"+"\n";
	TopSweeps += "TAG POS=1 TYPE=BUTTON FORM=NAME:NoFormName ATTR=ID:i-6020b74d-1b80-4e03-9f66-fefe77552aee"+"\n";
	TopSweeps += "WAIT SECONDS=0.5"+"\n";
